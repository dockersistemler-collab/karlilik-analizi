...
@section('content')
    <form method="POST" action="{{ route('admin.subuser.password.update') }}" class="panel-card p-6 space-y-5 max-w-xl">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.dashboard') }}" class="text-slate-500 hover:text-slate-700">Vazgeç</a>
        </div>
    </form>
@endsection
