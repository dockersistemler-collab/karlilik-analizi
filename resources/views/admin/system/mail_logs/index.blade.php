...
@section('content')
    ...
    <div class="panel-card p-4 mb-4">
        ...
        <form method="GET" action="{{ route('portal.system.mail-logs.index') }}" class="flex flex-col gap-3 md:flex-row md:items-end">
            ...
            <div class="flex flex-col gap-2">
                ...
                <label class="text-xs font-semibold text-slate-500">Kullanici</label>

                <input type="text" name="user" value="{{ $userQuery }}" placeholder="email veya ad">
                ...
                <tbody>
                    ...
                    @forelse($logs as $log)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-outline-accent" href="{{ route('portal.system.mail-logs.show', $log) }}">
                    ...
                    @empty
                        ...
                        <tr>
                            ...
                            <td colspan="7" class="text-center text-slate-500 py-6">Kayit bulunamadi.</td>
