...
@section('content')
    ...
    @php
        ...
        if ($supportViewEnabled && $user) {

            $user->email = \App\Support\SupportUser::maskEmail($user->email);
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-3 bg-white rounded-xl border border-slate-100 p-6">
                    ...
                    <div data-settings-panel="company" class="space-y-5">
                        ...
                        <form class="space-y-4" method="POST" action="{{ route('portal.settings.update', ['tab' => 'company']) }}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="text" name="company_phone" value="{{ old('company_phone', $supportViewEnabled ? \App\Support\SupportUser::maskPhone($user?->company_phone) : $user?->company_phone) }}" class="w-full border border-slate-200 rounded-lg px-3 py-2 bg-white">
                            ...
                            <div>
                                ...
                                <textarea rows="3" name="company_address" class="w-full border border-slate-200 rounded-lg px-3 py-2 bg-white">{{ old('company_address', $supportViewEnabled ? \App\Support\SupportUser::maskText($user?->company_address, 3, 3) : $user?->company_address) }}</textarea>
                    ...
                    <div data-settings-panel="invoice" class="hidden space-y-5">
                        ...
                        <form class="space-y-4" method="POST" action="{{ route('portal.settings.update', ['tab' => 'invoice']) }}">
                            ...
                            <div>
                                ...
                                <input type="email" name="billing_email" value="{{ old('billing_email', $supportViewEnabled ? \App\Support\SupportUser::maskEmail($user?->billing_email) : $user?->billing_email) }}" class="w-full border border-slate-200 rounded-lg px-3 py-2 bg-white">
                            ...
                            <div>
                                ...
                                <textarea rows="3" name="billing_address" class="w-full border border-slate-200 rounded-lg px-3 py-2 bg-white">{{ old('billing_address', $supportViewEnabled ? \App\Support\SupportUser::maskText($user?->billing_address, 3, 3) : $user?->billing_address) }}</textarea>
                    ...
                    <div data-settings-panel="notifications" class="hidden space-y-5">
                        ...
                        <form class="space-y-4" method="POST" action="{{ route('portal.settings.update', ['tab' => 'notifications']) }}">
