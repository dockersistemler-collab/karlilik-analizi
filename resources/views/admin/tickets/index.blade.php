...
@section('content')
        ...
        <div class="relative">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('portal.help.support') }}" class="btn btn-outline-accent">
    ...
    <div class="panel-card p-6 mb-6">
        ...
        <div class="flex items-center justify-between gap-3 mb-4">
            ...
            <a href="{{ route('portal.tickets.create') }}" class="text-sm font-semibold text-blue-600 hover:text-blue-700">Yeni Talep</a>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <a href="{{ route('portal.tickets.index') }}" class="btn btn-outline-accent">Temizle</a>
                ...
                @forelse($tickets as $ticket)
                    ...
                    <tr class="hover:bg-slate-50/60">
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            <a href="{{ route('portal.tickets.show', $ticket) }}" class="text-blue-600 hover:text-blue-800 font-semibold">Görüntüle</a>
