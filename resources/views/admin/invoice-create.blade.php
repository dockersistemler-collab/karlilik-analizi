...
@section('content')
    ...
    <div class="panel-card p-6 max-w-3xl">
        ...
        <form method="POST" action="{{ route('portal.invoices.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <label class="block text-sm font-medium text-slate-700">Müþteri Ara</label>

                <input id="customer-search" type="text" class="mt-1 w-full" placeholder="En az 2 harf girin">

                <div id="customer-results" class="mt-2 hidden rounded-lg border border-slate-200 bg-white text-sm"></div>

                <div id="customer-empty" class="mt-2 hidden rounded-lg border border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-500">

                    <div class="flex items-center justify-between gap-3">

                        <span>Kayýtlý müþteri bulunamadý.</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <label class="block text-sm font-medium text-slate-700">Müþteri Adý</label>
                ...
                <div>
                    ...
                    <select name="status" class="mt-1 w-full">
                        ...
                        <option value="failed" @selected(old('status') === 'failed')>Baþarýsýz</option>

                        <option value="refunded" @selected(old('status') === 'refunded')>Ýade</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="billing-address" name="billing_address" rows="3" class="mt-1 w-full">{{ old('billing_address') }}</textarea>
            ...
            <div class="flex items-center gap-3">
                ...
                <button type="submit">Fatura Oluþtur</button>

                <a href="{{ route('portal.invoices.index') }}" class="btn btn-outline-accent">Vazgeç</a>
    ...
    <div id="customer-modal" class="fixed inset-0 bg-slate-900/30 hidden items-center justify-center z-50">
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6">
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <h3 class="text-sm font-semibold text-slate-800">Yeni Müþteri</h3>
            ...
            <form id="customer-modal-form" class="space-y-4">
                ...
                <div class="panel-card p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <label class="block text-sm font-medium text-slate-700">Ýl</label>
                        ...
                        <div>
                            ...
                            <label class="block text-sm font-medium text-slate-700">Ýlçe</label>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <label class="block text-sm font-medium text-slate-700">Açýk Adres</label>
                ...
                <div class="panel-card p-4">
                    ...
                    <h3 class="text-sm font-semibold text-slate-800">Müþteri Türü</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <label id="modal-tax-label" class="block text-sm font-medium text-slate-700">TC Kimlik Numarasý</label>
...
<script>
    ...
    searchInput?.addEventListener('input', () => {
        ...
        timer = setTimeout(async () => {
            ...
            const response = await fetch(`{{ route('portal.invoices.customers') }}?q=${encodeURIComponent(query)}`);
            ...
            data.forEach((item) => {
                ...
                row.addEventListener('click', () => {
                    ...
                    addressInput.value = item.billing_address ?? '';
    ...
    function updateModalCustomerType() {
        ...
        if (selected === 'corporate') {
            ...
            modalTaxLabel.textContent = 'Vergi Kimlik Numarasý';
            ...
            modalTaxLabel.textContent = 'TC Kimlik Numarasý';
    ...
    modalForm?.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            response = await fetch('{{ route('portal.customers.store') }}', {
            ...
            showModalError('Müþteri kaydedilemedi. Lütfen tekrar deneyin.');
        ...
        if (!response.ok) {
            ...
            if (response.status === 422) {
                ...
                addressInput.value = payload.billing_address ?? '';
        ...
        addressInput.value = customer.billing_address ?? '';
