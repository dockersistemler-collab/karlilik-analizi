...
@section('content')
<div class="mb-6">
    <a href="{{ route('portal.marketplaces.create') }}" class="btn btn-solid-accent">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="{{ route('portal.marketplaces.show', $marketplace) }}" class="text-blue-600 hover:text-blue-900 mr-3">
                        <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('portal.marketplaces.edit', $marketplace) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">
                        <i class="fas fa-edit"></i>
                    </a>
                    <form action="{{ route('portal.marketplaces.destroy', $marketplace) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
