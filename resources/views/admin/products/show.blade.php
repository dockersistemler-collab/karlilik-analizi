...
<div class="bg-white rounded-lg shadow">
    ...
    <form id="bulk-mp-form" method="POST" action="{{ route('portal.marketplace-products.bulk-update') }}" class="p-6 border-b">
    ...
    <form method="POST" action="{{ route('portal.marketplace-products.bulk-sync') }}" class="p-6 border-b">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        ...
                        <details class="inline-block">
                            ...
                            <form action="{{ route('portal.marketplace-products.update', $mp) }}" method="POST" class="mt-2 space-y-2">
                        ...
                        <form action="{{ route('portal.marketplace-products.sync', $mp) }}" method="POST" class="inline">
                        ...
                        <form action="{{ route('portal.marketplace-products.destroy', $mp) }}" method="POST" class="inline">
...
<div id="assignModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        ...
        <div class="mt-3">
            ...
            <form action="{{ route('portal.marketplace-products.assign') }}" method="POST">
