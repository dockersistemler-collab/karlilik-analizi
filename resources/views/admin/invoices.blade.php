...
$ownerUser = auth()->user();
    ...
    <div class="panel-card p-4 mb-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
            ...
            <a href="{{ route('portal.invoices.create') }}" class="btn btn-outline-accent">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <label class="block text-xs text-gray-500 mb-1">Tarih (min)</label>

                <input type="date" name="date_from" value="{{ request('date_from') }}" class="w-full border-gray-300 rounded-md">

            </div>

            <div>

                <label class="block text-xs text-gray-500 mb-1">Tarih (max)</label>

                <input type="date" name="date_to" value="{{ request('date_to') }}" class="w-full border-gray-300 rounded-md">
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="{{ route('portal.invoices.index') }}" class="btn btn-outline-accent">Sıfırla</a>
            ...
            <div class="md:col-span-4">
                ...
                @if($canExport)
                    ...
                    <a href="{{ route('portal.invoices.export', request()->query()) }}" class="btn btn-outline-accent">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @forelse($invoices as $invoice)
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $invoice->issued_at?->format('d.m.Y') }}</td>

                        <td class="px-6 py-4 text-sm text-gray-600">{{ number_format($invoice->amount, 2) }} ₺</td>
                ...
                @empty
                    ...
                    <tr>
                        ...
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">Fatura bulunamadı.</td>
