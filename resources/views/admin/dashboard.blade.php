...
@section('content')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="panel-card p-6 lg:col-span-2">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-sm font-semibold text-slate-700">Satılan Ürünler İstatistikleri</h3>
                    <span class="text-xs text-slate-400">Grafik alanı</span>
                </div>
                <div class="flex flex-wrap items-center gap-2 mb-4">
                <a href="{{ route('admin.dashboard', ['range' => 'day']) }}"
        ...
        <div class="panel-card p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-slate-700">Yeni tema iyileştirmeleri eklendi.</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="panel-card p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-semibold text-slate-700">Pazaryeri Satış Dağılımı</h3>
        ...
        <div class="panel-card p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-semibold text-slate-700">En Çok Satan 10 Ürün</h3>
...
@push('scripts')
    ...
    <script src="{{ asset('vendor/leaflet/leaflet.js') }}"></script>
        ...
        const normalize = (value = '') => {
            const replacements = { 'ç': 'c', 'ğ': 'g', 'ı': 'i', 'İ': 'i', 'ö': 'o', 'ş': 's', 'ü': 'u' };
