    ...
    <div class="panel-card p-6 mb-6">
        ...
        <form method="GET" class="flex flex-wrap lg:flex-nowrap items-end gap-3">
            ...
            <div class="flex items-center gap-2 lg:ml-auto">
                ...
                <a href="{{ route('portal.reports.sold-products') }}" class="btn btn-outline">Temizle</a>

                <a href="{{ route('portal.reports.sold-products.print', request()->query()) }}" target="_blank" class="btn btn-outline">Yazdýr</a>
