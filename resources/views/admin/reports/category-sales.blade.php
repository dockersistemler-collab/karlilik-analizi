                            ...
                            <td colspan="5">
                                <div class="rp-detail-panel">
                                    ...
                                    <div class="rp-inline-collapse-wrap">
                                        <button type="button" class="rp-inline-collapse" data-category-inline-close title="Detayı kapat" aria-label="Detayı kapat">
...
@push('scripts')
    <script>
        (function () {
            ...
            document.querySelectorAll('[data-category-inline-close]').forEach((btn) => {
                btn.addEventListener('click', () => {
