...
@section('content')
    <div class="panel-card p-6 mb-6">
        <form method="GET" class="flex flex-wrap lg:flex-nowrap items-end gap-3">
            ...
            <div class="flex items-center gap-2 lg:ml-auto">
                ...
                <a href="{{ route('admin.reports.category-sales') }}" class="btn btn-outline">Temizle</a>
            </div>
        </form>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="panel-card p-6">
            <h3 class="text-sm font-semibold text-slate-700 mb-4">Kategori Bazlı Ciro</h3>
            <div class="h-64">
                <canvas id="category-revenue-chart"></canvas>
            </div>
        </div>
        <div class="panel-card p-6">
            <h3 class="text-sm font-semibold text-slate-700 mb-4">Kategori Bazlı Toplam Sipariş</h3>
            <div class="h-64">
...
@push('scripts')
    ...
    <script>
        ...
        new Chart(document.getElementById('category-orders-chart'), createConfig(chartType, orders, 'Sipariş'));
    </script>
@endpush
