...
@section('content')
    ...
    <div class="panel-card p-6 max-w-4xl">
        ...
        <form method="POST" action="{{ route('portal.customers.update', $customer) }}" class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('portal.customers.show', $customer) }}" class="btn btn-outline-accent">Vazgeç</a>
