...
@section('content')
    ...
    <div class="panel-card p-4 mb-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
            ...
            <a href="{{ route('portal.customers.create') }}" class="btn btn-outline-accent">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="{{ route('portal.customers.index') }}" class="text-slate-500 hover:text-slate-700">Sıfırla</a>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('portal.customers.show', $customer) }}" class="text-blue-600 hover:text-blue-900">Görüntüle</a>

                                <a href="{{ route('portal.customers.edit', $customer) }}" class="text-slate-600 hover:text-slate-900">Düzenle</a>

                                <form method="POST" action="{{ route('portal.customers.destroy', $customer) }}">
