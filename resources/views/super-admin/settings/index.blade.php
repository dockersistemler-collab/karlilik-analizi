...
@section('content')
    <div class="panel-card p-4 mb-6">
        <div class="flex flex-wrap gap-2">
            <button type="button" class="tab-button btn btn-outline" data-tab-button="client">Müşteri Ayarları</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="exports">Rapor Dışa Aktarım</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="vat">KDV Kart Renkleri</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="category-mapping">Kategori Eşitleme</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="quick">Hızlı Menü</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="theme">Panel Görünümü</button>
            <button type="button" class="tab-button btn btn-outline" data-tab-button="referral">Tavsiye Programı</button>
        </div>
    </div>
...
@push('scripts')
    <script>
        ...
        const storedTab = localStorage.getItem(tabStorageKey) || 'client';
