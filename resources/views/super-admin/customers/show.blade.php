    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-4xl">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Client: {{ $customer->user?->name ?? '-' }}</p>
            </div>
        ...
        <div class="mt-6 flex items-center gap-3">
            ...
            <a href="{{ route('super-admin.customers.index') }}" class="text-slate-500 hover:text-slate-700">Listeye Dön</a>
        </div>
    </div>
@endsection
