    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-3xl">
        <form method="POST" action="{{ route('super-admin.invoices.store') }}" class="space-y-5">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('super-admin.invoices.index') }}" class="text-slate-500 hover:text-slate-700">Vazgeç</a>
            </div>
        </form>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6">
            ...
            <form id="customer-modal-form" class="space-y-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button id="cancel-customer-modal" type="button" class="text-slate-500 hover:text-slate-700">Vazgeç</button>
                </div>
            </form>
        </div>
    </div>
